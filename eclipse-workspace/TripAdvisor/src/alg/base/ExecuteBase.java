...
public class ExecuteBase 
{
	public static void main(String[] args) {
        ...
        String itemFile = folder + File.separator + "hotelsBase.csv";
        String trainFile = folder + File.separator + "reviewTraining.csv";
        String testFile = folder + File.separator + "reviewTesting.csv";
