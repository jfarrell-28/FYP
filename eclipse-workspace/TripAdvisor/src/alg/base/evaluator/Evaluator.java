...
import alg.base.ExecuteBase;
import utill.Item;
import util.reader.DatasetReader;

public class Evaluator 
{		
	private NPRecommender alg; // non-personalised recommender algorithm
	 ...
	 */
	public Evaluator(final NPRecommender alg, final DatasetReader reader, final int k)
	{
		this.alg = alg;
		this.reader = reader;
		this.k = k;
...
//
//		Map<Integer,Item> items = reader.getItemProfiles();
//		for (Integer itemId: items.keySet()) {
//			List<Integer> recs = alg.getRecommendations(itemId);
...
//	}
	 ...
	 */
	public double getNumberCommonRecs(NPRecommender alg1, NPRecommender alg2) {
		int sumCommon = 0;
